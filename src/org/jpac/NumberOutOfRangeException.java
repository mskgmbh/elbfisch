 ...
 * MODULE    : NumberOutOfRangeException.java
 * VERSION   : -
 * DATE      : -
 * PURPOSE   : 
...
public class NumberOutOfRangeException extends ProcessException{
    ...
    public NumberOutOfRangeException(double value, double minValue, double maxValue) {
        super("value: " + value + " range: " + minValue + " ... " + maxValue);
    }
}
