...
public class DwordRxTx extends RxTx{
     ...
     */
    public DwordRxTx(Connection conn, Address address, int dataOffset, Data data) throws IndexOutOfRangeException{
     ...
     */
    @Override
    public DwordRxTx read() throws IOException{
        super.read();
        return this;
    }
     ...
     */
    public DwordRxTx set(long value) throws AddressException, ValueOutOfRangeException {
        getData().setDWORD(dataOffset, value);
        return this;
    }
    ...
    public long get() throws AddressException {
        return getData().getDWORD(dataOffset);
    }
