 ...
 * MODULE    : TooManyRequestsException.java
 * VERSION   : $Revision$
 * DATE      : $Date$
 * PURPOSE   : thrown, if the maximum PDU size will be exceeded while adding a further request
...
/**
 * throw, if the overall size of requests stored inside a request set would exceed the user data size of a pdu, if
 * an additional request would be added
 */
