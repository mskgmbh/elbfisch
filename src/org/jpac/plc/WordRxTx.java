...
/**
 * Used to transfer a word value between the java application and the plc
 * Can be used standalone or in the context of a complex data structure (STRUCT)
 */
public class WordRxTx extends RxTx{
    /**
     ...
     */
    public WordRxTx(Connection conn, Address address, int dataOffset, Data data) throws IndexOutOfRangeException{
     ...
     */
    @Override
    public WordRxTx read() throws IOException{
        super.read();
        return this;
    }
     ...
     */
    public WordRxTx set(int value) throws AddressException, ValueOutOfRangeException {
        getData().setWORD(dataOffset, value);
        return this;
    }
    ...
    public int get() throws AddressException {
        return getData().getWORD(dataOffset);
    }
