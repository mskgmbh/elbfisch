 ...
 * MODULE    : WrongOrdinaryException.java
 * VERSION   : $Revision$
 * DATE      : $Date$
 * PURPOSE   : used to transfer bit objects from/to a plc
...
/**
 * thrown, if an enum does not contain a value with a given ordinary
 */
public class WrongOrdinaryException extends java.lang.Exception{
    
    /** Creates a new instance of WrongOrdinaryException */
    public WrongOrdinaryException(String extext) {
        super(extext);
    }
